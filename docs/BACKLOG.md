...
- [ ] **1. (Wow moment) Interactive opt-out checklist with recheck scheduling**
...
- [ ] **2. Category filtering and urgency-first sorting**
...
- [ ] **3. State privacy-law lookup panel**
...
- [ ] **4. Design polish: paper-and-ink craft pass**
...
- [ ] **5. Expand broker dataset to ~40 verified entries**
...
- [ ] **6. Expand state law dataset to all enacted-law states**
...
- [ ] **7. Stale-data flagging in the UI**
...
- [ ] **8. Import/export opt-out progress**
...
- [ ] **9. First-visit onboarding state**
...
- [ ] **10. "What to do today" prioritized view**
